...
import tableSizes from '../assets/table_sizes.json';
...
const initialState = {iteration: 0, arrangement: Array.from({ length: seatsNum }, (_, index) => index + 1), seatCosts: Array(seatsNum).fill(1), score: 0, guestMapping, tableSizes};
